    ...
    return (
        <section className="relative overflow-hidden border-b border-line bg-gradient-to-r from-ivory via-white to-[#fff8e8]">
            ...
            <Container className="relative flex min-h-0 flex-col justify-center py-6 sm:py-8 lg:py-9">
                ...
                {body && (
                    <p className="mt-2 max-w-xl text-sm leading-6 text-ink sm:mt-2.5 sm:text-base sm:leading-7">
                        {body}
                    </p>
                )}
                {actions && (
                    <BtnRow className="mt-4 sm:mt-5">
                        <ButtonLink className="w-full sm:w-auto" href="/apply" size="md" variant="gold">
                            Check eligibility
                        </ButtonLink>
                        <ButtonLink className="w-full sm:w-auto" href="/help" size="md" variant="outline">
                            How it works
                        </ButtonLink>
                    </BtnRow>
                )}
