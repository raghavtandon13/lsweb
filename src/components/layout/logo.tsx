...
export function Logo({
  ...
  return (
    <Link href="/" className={cn("group inline-flex min-w-0 items-center gap-2 sm:gap-2.5", className)}>
      <span
        className={cn(
      ...
      <span className="flex min-w-0 flex-col leading-none">
        ...
        {!compact && (
          <span className={cn("hidden text-[10px] uppercase tracking-[0.16em] sm:block sm:text-xs", dark ? "text-white" : "text-gold-deep")}>
            Loan marketplace
          </span>
        )}
      </span>
