    ...
    <div ref={box} className={cn("relative", className)}>
      ...
      {open && (
        <div className="absolute right-0 top-full z-[80] mt-2 w-[min(260px,calc(100vw-1.5rem))] rounded-2xl border border-line bg-white p-3 shadow-lift max-sm:fixed max-sm:left-3 max-sm:right-3 max-sm:top-[3.6rem] max-sm:mt-0 max-sm:w-auto">
          ...
          <p className="mb-2 mt-3 text-[11px] font-semibold uppercase tracking-[0.14em] text-muted">Your colour</p>
          ...
          <label className="mt-3 block">
            <span className="mb-1 block text-[11px] font-semibold uppercase tracking-[0.14em] text-muted">Hue</span>
            <input
              type="range"
              min={0}
              max={360}
          ...
          <label className="mt-2 block">
            <span className="mb-1 block text-[11px] font-semibold uppercase tracking-[0.14em] text-muted">Saturation</span>
            <input
              type="range"
              min={8}
              max={90}
          ...
          <label className="mt-2 block">
            <span className="mb-1 block text-[11px] font-semibold uppercase tracking-[0.14em] text-muted">Lightness</span>
            <input
              type="range"
              min={8}
              max={55}
