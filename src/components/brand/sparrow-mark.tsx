...
export function SparrowMark({ className }: { className?: string }) {
    return (
        <svg aria-hidden className={cn("overflow-visible", className)} fill="none" viewBox="0 0 80 64">
            <g fill="currentColor">
            ...
            <circle cx="61" cy="22" fill="white" r="2.1" />
            <circle cx="61.6" cy="21.6" fill="var(--gold-deep)" r="1" />
        </svg>
    );
}
