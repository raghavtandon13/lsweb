...
export function ProductStrip() {
    return (
        <section className="bg-ivory" id="loans">
                    ...
                    <div className="min-w-0 lg:col-span-8">
                        <Reveal>
                            ...
                            <h2 className="mt-2 font-serif text-3xl text-navy sm:text-4xl lg:text-5xl">
                                Pick a loan. See if you qualify.
                            </h2>
                            <p className="mt-4 max-w-xl text-base leading-7 text-ink sm:text-lg sm:leading-8">
                                Personal, gold, payday, deposit and business loans from partner NBFCs. Credit cards sit
                                under Credit.
                            </p>
                        </Reveal>
                        <div className="mt-8 grid grid-cols-2 gap-3 sm:mt-10 sm:grid-cols-4 sm:gap-6">
                            {getLoans().map((p, i) => {
                                ...
                                return (
                                    <Reveal className="h-full" delay={i * 40} key={p.slug}>
                                        <Link
                                        ...
                                        >
                                            <img
                                                ...
                                                src={visual?.image}
                                            />
                                            <p className="mt-3 text-[12px] font-semibold leading-4 text-navy sm:text-[13px]">
                                                {p.name}
                                            </p>
