...
const steps = [
    { n: "1", title: "Name & OTP", body: "We send an OTP to your number.", hue: "text-spark-gold" },
    {
        n: "2",
        title: "Basic details",
        body: "PAN, pincode, income, work type and date of birth.",
        hue: "text-spark-mint",
    },
    {
        n: "3",
        title: "CIBIL OTP",
        body: "Soft check with consents. It will not affect your score.",
        hue: "text-spark-sky",
    },
    {
        n: "4",
        title: "Score & lenders",
        body: "See your CIBIL snapshot, then eligible partner offers.",
        hue: "text-spark-coral",
    },
];
        ...
        <section className="relative overflow-hidden bg-white py-12 sm:py-16 lg:py-24">
            <Container className="grid items-center gap-8 lg:grid-cols-12 lg:gap-12">
                <div className="lg:col-span-7">
                    ...
                    <Reveal delay={200}>
                        <ButtonLink className="mt-8 w-full sm:w-auto" href="/help" variant="outline">
                            See all steps
                        </ButtonLink>
                    </Reveal>
                </div>
