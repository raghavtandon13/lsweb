        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-[#eaf8f6] via-white to-[#f4fbfa]">
            <div className="pointer-events-none absolute inset-0 opacity-70">
                ...
                <svg className="absolute inset-0 h-full w-full" preserveAspectRatio="none" viewBox="0 0 1440 800">
                    ...
                    <rect fill="url(#hero-grid)" height="800" width="1440" />
                    <path
            ...
            <Container className="relative grid items-center gap-6 py-12 lg:grid-cols-2 lg:gap-4 lg:py-16 xl:py-20">
                <div>
                    ...
                    <p className="mt-5 max-w-lg text-lg leading-8 text-muted">
                        Compare offers from partner NBFCs. Apply when you are ready — eligibility starts in a short
                        form, not on this page.
                    </p>
                    <BtnRow className="mt-8">
                        <ButtonLink className="w-full sm:w-auto" href="/apply" size="lg" variant="gold">
                            Check eligibility <ArrowRight className="h-4 w-4" />
                        </ButtonLink>
                        <ButtonLink className="w-full sm:w-auto" href="#loans" size="lg" variant="outline">
                            Explore loans
                        </ButtonLink>
                    </BtnRow>
