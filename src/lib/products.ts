...
export const products: Product[] = [
    {
        ...
        summary: "Short-term loan until your salary is credited. Apply online and get offers from partner NBFCs.",
        amountMin: 5_000,
        amountMax: 50_000,
        tenure: "7 – 45 days",
    ...
    },
    {
        ...
        summary: "For expenses you will repay within a year — medical, travel, gadgets or a small event.",
        amountMin: 10_000,
        amountMax: 2_00_000,
        tenure: "1 – 12 months",
        ...
        caution: "Shorter tenors mean higher EMIs. Check the EMI against your surplus, not your gross salary.",
    },
    {
        slug: "personal",
        name: "Personal Loan",
        ...
        steps: [
            ...
            {
                title: "e-sign the lender agreement",
                body: "You contract with the NBFC, not with LoanSparrow as lender.",
            },
    ...
    },
    {
        ...
        eyebrow: "Secured",
        headline: "Gold loan",
        summary: "Borrow against hallmarked gold without selling it. Valuation and custody stay with the partner NBFC.",
        amountMin: 25_000,
        amountMax: 50_00_000,
    ...
    },
    {
        ...
        documents: ["PAN, Aadhaar", "CAMS / KFin / RTA statement or CAS", "Bank account for disbursal (same PAN)"],
        steps: [
    ...
    },
    {
        ...
        documents: ["PAN, Aadhaar", "FD receipt / advice", "Cancelled cheque of the linked account"],
        steps: [
    ...
    },
    {
        ...
        documents: ["KYC", "FD booking / lien form", "Photograph and signature as required by issuer"],
        steps: [
    ...
    },
    {
        ...
        summary: "GST-registered businesses can apply for working capital based on banking and GST, not a mortgage.",
        amountMin: 1_00_000,
        amountMax: 50_00_000,
        tenure: "12 – 48 months",
