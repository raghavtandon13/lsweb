    ...
    return (
        <>
            <ol className="grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
                {beats.map((b, i) => (
                    <li className="rounded-2xl border border-line bg-white p-5" key={b.t}>
            ...
            <BtnRow className="mt-8">
                <ButtonLink className="w-full sm:w-auto" href="/apply" size="md">
                    Check eligibility
                </ButtonLink>
                <ButtonLink className="w-full sm:w-auto" href="/help/faqs" size="md" variant="outline">
                    FAQs
                </ButtonLink>
            </BtnRow>
        </>
...
function ContactTab() {
    ...
    return (
        <div className="grid gap-6 lg:grid-cols-12">
            <form className="card space-y-5 p-5 sm:p-6 lg:col-span-7" onSubmit={onSubmit}>
                {sent ? (
    ...
    return (
        <div className="grid gap-8 lg:grid-cols-12">
            <div className="prose-legal lg:col-span-7">
                <p>
                    LoanSparrow lets you check eligibility for payday, personal, gold, FD, mutual fund, business loans
                    and credit cards in one place. You see named offers before you continue with a lender.
                </p>
                <h2>What we do</h2>
                <ul>
                ...
                <p>
                    We do not ask you to send gold, cash or “processing” money to an individual. Insurance is optional.
                    Any lender fee is shown on the offer before you accept.
                </p>
            </div>
...
export default function HelpPage() {
    ...
    return (
        <>
            <PageHero body={hero.body} eyebrow={hero.eyebrow} title={hero.title} />
