  ...
  if (!product) {
    return (
      <div className="px-5 py-24 text-center">
        ...
        <ButtonLink href="/" className="mx-auto mt-8">
          Home
        </ButtonLink>
      </div>
    );
          ...
          <section>
            ...
            <ul className="mt-4 grid gap-3 sm:grid-cols-2">
              {product.highlights.map((h) => (
                <li key={h} className="rounded-2xl border border-line bg-white px-4 py-3.5 text-sm leading-6 text-navy sm:text-base sm:leading-7">
                  {h}
                </li>
              ))}
            </ul>
        ...
        <aside className="lg:col-span-4">
          <div className="sticky top-20 overflow-hidden rounded-[1.25rem] border border-line bg-white shadow-lift">
            ...
            <div className="p-5 sm:p-6">
              ...
              <ButtonLink href="/apply" className="mt-5 w-full" size="md">
                Check eligibility
              </ButtonLink>
