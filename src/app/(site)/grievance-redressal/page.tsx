...
export default function GrievancePage() {
  return (
    ...
    >
      <p>
        If something is wrong — a consent you did not give, an offer that vanished, a rude call, a payment dispute we
        can route — start here so the complaint is logged.
      </p>
      <h2>Level 1 — Support</h2>
      <p>
        Email {site.supportEmail} or use dashboard Support. Mention your application ID and mobile. We aim to
        acknowledge within 3 working days and resolve within 15 working days where LoanSparrow controls the issue.
      </p>
      ...
      <p>
        Sanction, EMI bounce, foreclosure quotes, and gold custody are the partner NBFC/bank’s responsibility. We
        forward the complaint and share their grievance contacts. Their TAT applies.
      </p>
      <h2>RBI Ombudsman</h2>
