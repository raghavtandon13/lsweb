      ...
      <Container className="grid gap-10 py-14 lg:grid-cols-12 lg:py-16">
        <div className="prose-legal lg:col-span-7">
          <p>
            ...
            place. You see named offers — amount, interest and fees — before you continue with a lender.
          </p>
          <h2>What we do</h2>
          <ul>
          ...
          <p>
            We do not ask you to send gold, cash or “processing” money to an individual. Insurance is optional. Any
            lender fee is shown on the offer before you accept.
          </p>
        </div>
