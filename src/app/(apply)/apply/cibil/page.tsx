        ...
        <div className="space-y-4 sm:space-y-5">
            <Link className="card flex items-center gap-3 p-4 sm:gap-5 sm:p-5" href="/apply/cibil/details">
                ...
                <div className="min-w-0 flex-1">
                    <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-spark-gold">
                        {report.band}
                    </p>
                    <p className="mt-0.5 font-serif text-xl text-navy sm:text-2xl">CIBIL score</p>
                    <p className="mt-1 text-xs text-muted sm:text-sm">
                        Tap for full details · It will not affect your score
                    </p>
                </div>
                <ChevronRight aria-hidden className="h-5 w-5 shrink-0 text-navy sm:h-6 sm:w-6" />
            </Link>
                    ...
                    {noOffer ? (
                        <div className="card space-y-3 p-5 sm:p-6">
                            ...
                            <p className="text-sm leading-6 text-muted">
                                Let's check your credit history and make a few changes by Credit Cure so you can get
                                eligible for an offer.
                            </p>
                            <Button onClick={() => setTab("sudhar")} type="button">
                                Credit Cure
                            </Button>
                        </div>
                    ) : (
                        <>
                            <p className="text-sm text-muted">
                                Partners who can price this profile. Soft check did not change your score.
                            </p>
